\documentclass[master,eng,fulltime,print,cenhdr,normaltoc,blind]{buptthesis} % 专硕印刷版
...
% 导入宏包
\usepackage{graphicx}
\graphicspath{{resources/}{resource/figures/}{resource/system_demo/}}
\usepackage{bbding}
\usepackage{booktabs}
...
\BUPTthesiscntitlepage{%
	...
	title = {多主体信息传播影响力评估系统 \\ 的设计与实现},  % 本章标题
	studentid = {2023140881}, % 学号
	name = {贾志远}, % 姓名
	major = {计算机技术}, % 专业名称
	supervisor = {程渤}, % 导师姓名
	institute = {计算机学院（国家示范性软件学院）} % 单行学院的写法
...
\BUPTdateOptions{%
    ...
    dissertationDay = {23} % 答辩时间的天
}

\BUPTthesisentitlepage{%
	confidentialEN = {Public},  % 目前只支持公开
	titleEN = {Design and Implementation of Multi-Agent \\ Information Propagation Influence Assessment System}, % 本章标题
	nameEN = {Jia Zhiyuan}, % 姓名
	majorEN = {Computer Technology}, % 专业名称
	supervisorEN = {Cheng Bo}, % 导师姓名
	instituteEN = {School of Computer Science\\(National Pilot Software Engineering School), BUPT} % 学院名称
	%instituteEN = {Your Institute1\\Your Institute2} % 双行学院的写法
}

\BUPTdissertationcommitteepage{%
	committeeChairName = {吴步丹}, % 主席名称
	committeeChairTitle = {副教授}, % 主席职称
	committeeChairOrgan = {北京邮电大学}, % 主席单位
	committeeMemberFirstName = {程渤}, % 委员1名称
	committeeMemberFirstTitle = {教授},
	committeeMemberFirstOrgan = {北京邮电大学},
	committeeMemberSecondName = {李常宝},
	committeeMemberSecondTitle = {研究员},
	committeeMemberSecondOrgan = {中国电科第十五研究所},
	committeeMemberThirdName = {王国伟},
	committeeMemberThirdTitle = {高级工程师},
	committeeMemberThirdOrgan = {中国电子科技集团有限公司},
	committeeMemberFourthName = {},
	committeeMemberFourthTitle = {},
	committeeMemberFourthOrgan = {},
	committeeSecretaryName = {陈勇}, % 秘书名称，电话：13810427976
...
\mainmatter
\include{Chapter/Chapter_1} % 第一章 绪论
\include{Chapter/Chapter_2} % 第二章 相关技术与理论基础
\include{Chapter/Chapter_3} % 第三章 系统需求分析与概要设计
\include{Chapter/Chapter_4} % 第四章 基于组感知融合的评论传播价值评估模型
\include{Chapter/Chapter_5} % 第五章 基于交互感知的异构路径传播延续预测模型
\include{Chapter/Chapter_6} % 第六章 多主体信息传播影响力评估系统的实现与测试
\include{Chapter/Chapter_7} % 第七章 总结与展望

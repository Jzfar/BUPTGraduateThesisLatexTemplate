...
随着AI代理与人类用户共存于社交媒体传播系统，信息传播评估面临新的挑战：现有工具无法在评论级别区分不同主体的传播价值分布，也无法在讨论链层面量化人-机交互序列对传播延续的影响。本章围绕这一评估需求，对多主体信息认知传播评估系统展开需求分析与概要设计。
...
本章围绕多主体信息认知传播评估系统完成了需求分析与概要设计。需求分析从功能性和非功能性两个方面展开，功能性需求涵盖数据导入与预处理、评论传播价值评估、传播延续预测、多主体对比分析及评估结果展示与管理五类核心功能，非功能性需求从性能、可扩展性和易用性三个方面提出约束。概要设计采用四层架构，将评估算法模块与业务层解耦，划分6个功能模块并定义了5张数据表的完整schema，为后续章节的算法设计与系统实现奠定了整体框架。